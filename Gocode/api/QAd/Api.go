...
//Prints if it finds one currently will not end current thread will just print.
//Ending current thread if current copied out.
...
//This is used for decoding request header. Simply decode and put into map.
//Returns a varaible of all json vars that were in the payload.
...
//If you pass queryString that too will be edited accordingly to params passed.
...
//So requests are able to go out which the browser would normally stop
